    ...
    <>
      <section className="py-16 bg-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#333] max-w-3xl mx-auto mb-8">{whatYouWillReceive.headline}</h2>
      ...
      <section className="py-16 bg-[#F5F5F5] text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#333]">{exclusiveBonuses.headline1} <span className="text-[#7ED957]">{exclusiveBonuses.headline2}</span></h2>
          <div className="mt-12 flex flex-col md:flex-row justify-center items-center gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800">{exclusiveBonuses.bonus1.title}</h3>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800">{exclusiveBonuses.bonus2.title}</h3>
            </div>
          </div>
        </div>
      </section>
